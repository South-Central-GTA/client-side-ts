import {ClothingInterface} from "./clothing.interface";

export interface ClothesInterface {
    hat: ClothingInterface;
    glasses: ClothingInterface;
    ears: ClothingInterface;
    watch: ClothingInterface;
